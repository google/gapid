...
import com.google.gapid.proto.service.path.Path.Capture;
...
public class QueryEngine {
  ...
  public QueryEngine(Client client, Capture capture, StatusBar status) {
    this.client = client;
    this.capture = capture;
    this.status = status;
  }

  public ListenableFuture<Service.PerfettoQueryResult> raw(String sql) {
  ...
  public static class Result {
    private final Service.PerfettoQueryResult res;

    public Result(PerfettoQueryResult res) {
      this.res = res;
    }
    ...
    public long getLong(int row, int column, long deflt) {
      Service.PerfettoQueryResult.ColumnValues c = res.getColumns(column);
