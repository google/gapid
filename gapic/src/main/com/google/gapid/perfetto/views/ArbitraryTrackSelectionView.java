...
public class ArbitraryTrackSelectionView extends Composite {
  public ArbitraryTrackSelectionView(
      Composite parent, State state, ArbitraryTrackTrack.Slice slice) {
