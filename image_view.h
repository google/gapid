...
struct VkImageViewWrapper : handle_base<VkImageView> {
  VkImageViewWrapper(HandleUpdater*, VkDevice, VkImageView image_view)
      : handle_base<VkImageView>(image_view) {}

  void set_create_info(const VkImageViewCreateInfo* pCreateInfo) {
