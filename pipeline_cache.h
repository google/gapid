...
struct VkPipelineCacheWrapper : handle_base<VkPipelineCache> {
  VkPipelineCacheWrapper(HandleUpdater*, VkDevice, VkPipelineCache pipeline)
      : handle_base<VkPipelineCache>(pipeline) {}

  void set_create_info(const VkPipelineCacheCreateInfo* pCreateInfo) {
