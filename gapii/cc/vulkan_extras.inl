...
uint32_t SpyOverride_vkCreateSwapchainKHR(VkDevice device, VkSwapchainCreateInfoKHR* pCreateInfo, VkAllocationCallbacks* pAllocator, VkSwapchainKHR* pImage);
...
void SpyOverride_RecreateCmdUpdateBuffer(VkCommandBuffer, VkBuffer, VkDeviceSize, VkDeviceSize, const void*) {}
...
void SpyOverride_RecreateCmdNextSubpass(VkCommandBuffer, uint32_t /*VkSubpassContents*/) {}
