...
DECL_GAPIL_ENCODER_CB(int64_t, gapil_encode_type, gapil_context* ctx,
                      uint8_t* name, uint32_t desc_size, void* desc);
...
DECL_GAPIL_ENCODER_CB(void*, gapil_encode_object, gapil_context* ctx,
...
DECL_GAPIL_ENCODER_CB(int64_t, gapil_encode_backref, gapil_context* ctx,
                      void* object);
...
DECL_GAPIL_ENCODER_CB(void, gapil_slice_encoded, gapil_context* ctx,
                      gapil_slice* slice);
