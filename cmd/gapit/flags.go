...
type (
	...
	TraceFlags struct {
		...
		API   string `help:"only capture the given API valid options are gles, vulkan, and system_trace"`
		Local struct {
		...
		SystemTrace string `help:"File containing the System Trace configuration proto."`
	}
