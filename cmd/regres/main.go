...
type stats struct {
	...
	FileSizes            struct { // in bytes
		...
		LibVkLayerVulkanCPUTiming  int `name:"libVkLayer_VulkanCPUTiming"`
...
func run(ctx context.Context) error {
	...
	for i := range cls {
		...
		for _, f := range []struct {
			...
			{filepath.Join(pkgDir, "lib", dllExt("libVkLayer_VulkanCPUTiming")), &r.FileSizes.LibVkLayerVulkanCPUTiming},
