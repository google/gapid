...
inline void _custom_clone_VkClearValue(
    state_block*,
...
inline void _custom_deserialize_vkCmdPushConstants_pValues(
    state_block*,
...
inline void _custom_clone_VkClearColorValue(state_block*,
...
inline void _custom_serialize_VkClearColorValue(state_block*,
...
inline void _custom_serialize_VkClearValue(
    state_block*,
...
inline void _custom_deserialize_VkClearColorValue(state_block*,
...
inline void _custom_deserialize_VkClearValue(state_block*,
                                             VkClearValue& value,
                                             decoder* dec) {
...
inline uint64_t get_VkDescriptorUpdateTemplate_size(
...
inline void _custom_serialize_vkUpdateDescriptorSetWithTemplate_pData(
    state_block* state_block_,
    VkDevice device,
...
inline const void* _custom_unwrap_vkUpdateDescriptorSetWithTemplate_pData(
    state_block* state_block_,
...
inline void _custom_serialize_vkMapMemory_ppData(state_block*,
                                                 VkDevice device,
...
inline void _custom_serialize_vkGetPipelineCacheData_pData(
    state_block*,
    VkDevice device,
...
inline void _custom_serialize_vkCmdUpdateBuffer_pData(state_block*,
                                                      VkCommandBuffer commandBuffer,
                                                      VkBuffer dstBuffer,
...
inline void _custom_serialize_vkCmdPushConstants_pValues(state_block*,
                                                         VkCommandBuffer commandBuffer,
                                                         VkPipelineLayout layout,
                                                         VkShaderStageFlags stageFlags,
                                                         uint32_t offset,
...
inline void _custom_deserialize_vkUpdateDescriptorSetWithTemplate_pData(
    state_block*,
    VkDevice device,
    VkDescriptorSet descriptorSet,
    VkDescriptorUpdateTemplate descriptorUpdateTemplate,
...
inline void _custom_deserialize_vkMapMemory_ppData(state_block*,
                                                   VkDevice device,
                                                   VkDeviceMemory memory,
                                                   VkDeviceSize offset,
                                                   VkDeviceSize size,
...
inline void _custom_deserialize_vkGetQueryPoolResults_pData(state_block*,
                                                            VkDevice device,
                                                            VkQueryPool queryPool,
                                                            uint32_t firstQuery,
                                                            uint32_t queryCount,
...
inline void _custom_deserialize_vkGetPipelineCacheData_pData(
    state_block*,
    VkDevice device,
    VkPipelineCache pipelineCache,
    size_t* pDataSize,
...
inline void _custom_deserialize_vkCmdUpdateBuffer_pData(state_block*,
                                                        VkCommandBuffer commandBuffer,
                                                        VkBuffer dstBuffer,
                                                        VkDeviceSize dstOffset,
                                                        VkDeviceSize dataSize,
