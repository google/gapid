# The checked in protobuf BUILD file uses the CPU to detect MSVC, instead of the compiler option.
# This is not really protobuf's fault, but bazel's. It should be fixed soon-ish, probably.
# See https://cr.bazel.build/30290
