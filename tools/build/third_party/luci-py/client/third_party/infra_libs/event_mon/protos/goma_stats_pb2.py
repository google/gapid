...
_LOCALOUTPUTCACHESTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gc_count', full_name='devtools_goma.LocalOutputCacheStats.gc_count', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gc_total_time_ms', full_name='devtools_goma.LocalOutputCacheStats.gc_total_time_ms', index=11,
...
_HTTPRPCSTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='current_pending', full_name='devtools_goma.HttpRPCStats.current_pending', index=9,
      number=11, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='peak_pending', full_name='devtools_goma.HttpRPCStats.peak_pending', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='total_pending', full_name='devtools_goma.HttpRPCStats.total_pending', index=11,
      number=12, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='status_code', full_name='devtools_goma.HttpRPCStats.status_code', index=12,
...
_SUBPROCESSSTATS = _descriptor.Descriptor(
  name='SubProcessStats',
  full_name='devtools_goma.SubProcessStats',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='count_burst_by_network_error', full_name='devtools_goma.SubProcessStats.count_burst_by_network_error', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='count_burst_by_compiler_disabled', full_name='devtools_goma.SubProcessStats.count_burst_by_compiler_disabled', index=1,
...
_GOMASTATS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='subprocess_stats', full_name='devtools_goma.GomaStats.subprocess_stats', index=13,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='histogram', full_name='devtools_goma.GomaStats.histogram', index=14,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='machine_info', full_name='devtools_goma.GomaStats.machine_info', index=15,
...
_GOMASTATS.fields_by_name['subprocess_stats'].message_type = _SUBPROCESSSTATS
...
RequestStats = _reflection.GeneratedProtocolMessageType('RequestStats', (_message.Message,), dict(
  ...
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.RequestStats)
  ))
_sym_db.RegisterMessage(RequestStats)

CompilerProxyStats = _reflection.GeneratedProtocolMessageType('CompilerProxyStats', (_message.Message,), dict(
  DESCRIPTOR = _COMPILERPROXYSTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.CompilerProxyStats)
  ))
_sym_db.RegisterMessage(CompilerProxyStats)

CompilerInfoStats = _reflection.GeneratedProtocolMessageType('CompilerInfoStats', (_message.Message,), dict(
  DESCRIPTOR = _COMPILERINFOSTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.CompilerInfoStats)
  ))
_sym_db.RegisterMessage(CompilerInfoStats)

GomaCompileStats = _reflection.GeneratedProtocolMessageType('GomaCompileStats', (_message.Message,), dict(
  DESCRIPTOR = _GOMACOMPILESTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.GomaCompileStats)
  ))
_sym_db.RegisterMessage(GomaCompileStats)

LocalCompileStats = _reflection.GeneratedProtocolMessageType('LocalCompileStats', (_message.Message,), dict(
  DESCRIPTOR = _LOCALCOMPILESTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.LocalCompileStats)
  ))
_sym_db.RegisterMessage(LocalCompileStats)

FallbackInSetupStats = _reflection.GeneratedProtocolMessageType('FallbackInSetupStats', (_message.Message,), dict(
  DESCRIPTOR = _FALLBACKINSETUPSTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.FallbackInSetupStats)
  ))
_sym_db.RegisterMessage(FallbackInSetupStats)
...
OutputStats = _reflection.GeneratedProtocolMessageType('OutputStats', (_message.Message,), dict(
  DESCRIPTOR = _OUTPUTSTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.OutputStats)
  ))
_sym_db.RegisterMessage(OutputStats)
...
IncludeProcessorStats = _reflection.GeneratedProtocolMessageType('IncludeProcessorStats', (_message.Message,), dict(
  DESCRIPTOR = _INCLUDEPROCESSORSTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.IncludeProcessorStats)
  ))
_sym_db.RegisterMessage(IncludeProcessorStats)

IncludeCacheStats = _reflection.GeneratedProtocolMessageType('IncludeCacheStats', (_message.Message,), dict(
  DESCRIPTOR = _INCLUDECACHESTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.IncludeCacheStats)
  ))
_sym_db.RegisterMessage(IncludeCacheStats)

DepsCacheStats = _reflection.GeneratedProtocolMessageType('DepsCacheStats', (_message.Message,), dict(
  DESCRIPTOR = _DEPSCACHESTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.DepsCacheStats)
  ))
_sym_db.RegisterMessage(DepsCacheStats)

IncludeDirCacheStats = _reflection.GeneratedProtocolMessageType('IncludeDirCacheStats', (_message.Message,), dict(
  DESCRIPTOR = _INCLUDEDIRCACHESTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.IncludeDirCacheStats)
  ))
_sym_db.RegisterMessage(IncludeDirCacheStats)

LocalOutputCacheStats = _reflection.GeneratedProtocolMessageType('LocalOutputCacheStats', (_message.Message,), dict(
  DESCRIPTOR = _LOCALOUTPUTCACHESTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.LocalOutputCacheStats)
  ))
_sym_db.RegisterMessage(LocalOutputCacheStats)

HttpRPCStats = _reflection.GeneratedProtocolMessageType('HttpRPCStats', (_message.Message,), dict(
...
_sym_db.RegisterMessage(HttpRPCStats)
_sym_db.RegisterMessage(HttpRPCStats.HttpStatus)

GomaErrorStats = _reflection.GeneratedProtocolMessageType('GomaErrorStats', (_message.Message,), dict(
  DESCRIPTOR = _GOMAERRORSTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.GomaErrorStats)
  ))
_sym_db.RegisterMessage(GomaErrorStats)

GomaMismatchStats = _reflection.GeneratedProtocolMessageType('GomaMismatchStats', (_message.Message,), dict(
  DESCRIPTOR = _GOMAMISMATCHSTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.GomaMismatchStats)
  ))
_sym_db.RegisterMessage(GomaMismatchStats)

DistributionProto = _reflection.GeneratedProtocolMessageType('DistributionProto', (_message.Message,), dict(
  DESCRIPTOR = _DISTRIBUTIONPROTO,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.DistributionProto)
  ))
_sym_db.RegisterMessage(DistributionProto)

GomaHistograms = _reflection.GeneratedProtocolMessageType('GomaHistograms', (_message.Message,), dict(
  DESCRIPTOR = _GOMAHISTOGRAMS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.GomaHistograms)
  ))
_sym_db.RegisterMessage(GomaHistograms)
...
SubProcessStats = _reflection.GeneratedProtocolMessageType('SubProcessStats', (_message.Message,), dict(
  DESCRIPTOR = _SUBPROCESSSTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.SubProcessStats)
  ))
_sym_db.RegisterMessage(SubProcessStats)

GomaStats = _reflection.GeneratedProtocolMessageType('GomaStats', (_message.Message,), dict(
  DESCRIPTOR = _GOMASTATS,
  __module__ = 'goma_stats_pb2'
  # @@protoc_insertion_point(class_scope:devtools_goma.GomaStats)
  ))
_sym_db.RegisterMessage(GomaStats)


_GOMAERRORSTATS.fields_by_name['DEPRECATED_user_warning'].has_options = True
_GOMAERRORSTATS.fields_by_name['DEPRECATED_user_warning']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_MACHINEINFO.fields_by_name['DEPRECATED_cpu_capability'].has_options = True
_MACHINEINFO.fields_by_name['DEPRECATED_cpu_capability']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
_GOMASTATS.fields_by_name['incdircache_stats'].has_options = True
_GOMASTATS.fields_by_name['incdircache_stats']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
