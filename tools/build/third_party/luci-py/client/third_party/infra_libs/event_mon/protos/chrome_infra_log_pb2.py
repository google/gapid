...
_sym_db.RegisterEnumDescriptor(_CQEVENT_FAILUREREASON_FAILTYPE)
...
_sym_db.RegisterEnumDescriptor(_CQEVENT_ACTION)
...
_sym_db.RegisterEnumDescriptor(_CQEVENT_VERIFIER)
...
_sym_db.RegisterEnumDescriptor(_CQEVENT_STATUS)
...
_sym_db.RegisterEnumDescriptor(_SERVICEEVENT_SERVICEEVENTTYPE)
...
_sym_db.RegisterEnumDescriptor(_BUILDEVENT_BUILDEVENTTYPE)
...
_sym_db.RegisterEnumDescriptor(_BUILDEVENT_BUILDRESULT)
...
_sym_db.RegisterEnumDescriptor(_BUILDEVENT_GOMAERRORTYPE)
...
_sym_db.RegisterEnumDescriptor(_BUILDEVENT_CATEGORY)
...
_sym_db.RegisterEnumDescriptor(_BUILDEVENT_FAILTYPE)
...
_sym_db.RegisterEnumDescriptor(_TESTRESULTSEVENT_TESTRESULTTYPE)
...
_sym_db.RegisterEnumDescriptor(_MACHINEPROVIDEREVENT_GCEBACKENDMACHINESTATE)
...
_sym_db.RegisterEnumDescriptor(_MACHINEPROVIDEREVENT_GCEBACKENDDELETIONREASON)
...
_sym_db.RegisterEnumDescriptor(_MACHINEPROVIDEREVENT_MACHINEPROVIDERMACHINESTATE)
...
_sym_db.RegisterEnumDescriptor(_MACHINEPROVIDEREVENT_MACHINEPROVIDERAGENTSTATE)
...
_sym_db.RegisterEnumDescriptor(_ANALYZEEVENT_ANALYZERESULT)
...
_sym_db.RegisterEnumDescriptor(_SWARMINGTASKEVENT_STATE)
...
_sym_db.RegisterEnumDescriptor(_CHROMEINFRAEVENT_TIMESTAMPKIND)
...
_SWARMINGTASKEVENT_TAGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='spec_name', full_name='crit_event.proto.SwarmingTaskEvent.Tags.spec_name', index=10,
      number=11, type=9, cpp_type=9, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CHROMEINFRAEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='test_locations_event', full_name='crit_event.proto.ChromeInfraEvent.test_locations_event', index=12,
...
_BUILDEVENT.fields_by_name['goma_stats'].message_type = goma__stats__pb2._GOMASTATS
...
CQEvent = _reflection.GeneratedProtocolMessageType('CQEvent', (_message.Message,), dict(

  FailureReason = _reflection.GeneratedProtocolMessageType('FailureReason', (_message.Message,), dict(

    FailedTryJob = _reflection.GeneratedProtocolMessageType('FailedTryJob', (_message.Message,), dict(
      DESCRIPTOR = _CQEVENT_FAILUREREASON_FAILEDTRYJOB,
      __module__ = 'chrome_infra_log_pb2'
  ...
  TriggeredTryJob = _reflection.GeneratedProtocolMessageType('TriggeredTryJob', (_message.Message,), dict(
...
_sym_db.RegisterMessage(CQEvent)
_sym_db.RegisterMessage(CQEvent.FailureReason)
_sym_db.RegisterMessage(CQEvent.FailureReason.FailedTryJob)
_sym_db.RegisterMessage(CQEvent.TriggeredTryJob)
...
InfraEventSource = _reflection.GeneratedProtocolMessageType('InfraEventSource', (_message.Message,), dict(
  DESCRIPTOR = _INFRAEVENTSOURCE,
  __module__ = 'chrome_infra_log_pb2'
  # @@protoc_insertion_point(class_scope:crit_event.proto.InfraEventSource)
  ))
_sym_db.RegisterMessage(InfraEventSource)

TestResultsEvent = _reflection.GeneratedProtocolMessageType('TestResultsEvent', (_message.Message,), dict(
...
_sym_db.RegisterMessage(TestResultsEvent)
_sym_db.RegisterMessage(TestResultsEvent.TestResult)

MachineProviderEvent = _reflection.GeneratedProtocolMessageType('MachineProviderEvent', (_message.Message,), dict(
  DESCRIPTOR = _MACHINEPROVIDEREVENT,
  __module__ = 'chrome_infra_log_pb2'
  # @@protoc_insertion_point(class_scope:crit_event.proto.MachineProviderEvent)
  ))
_sym_db.RegisterMessage(MachineProviderEvent)

AnalyzeEvent = _reflection.GeneratedProtocolMessageType('AnalyzeEvent', (_message.Message,), dict(
  DESCRIPTOR = _ANALYZEEVENT,
  __module__ = 'chrome_infra_log_pb2'
  # @@protoc_insertion_point(class_scope:crit_event.proto.AnalyzeEvent)
  ))
_sym_db.RegisterMessage(AnalyzeEvent)

SwarmingTaskEvent = _reflection.GeneratedProtocolMessageType('SwarmingTaskEvent', (_message.Message,), dict(
  ...
  FilesRef = _reflection.GeneratedProtocolMessageType('FilesRef', (_message.Message,), dict(
  ...
  CipdInput = _reflection.GeneratedProtocolMessageType('CipdInput', (_message.Message,), dict(
...
_sym_db.RegisterMessage(SwarmingTaskEvent)
_sym_db.RegisterMessage(SwarmingTaskEvent.Dimensions)
_sym_db.RegisterMessage(SwarmingTaskEvent.Tags)
_sym_db.RegisterMessage(SwarmingTaskEvent.FilesRef)
_sym_db.RegisterMessage(SwarmingTaskEvent.CipdPackage)
_sym_db.RegisterMessage(SwarmingTaskEvent.CipdInput)
_sym_db.RegisterMessage(SwarmingTaskEvent.TaskProperties)
_sym_db.RegisterMessage(SwarmingTaskEvent.TaskRequest)

TestLocationsEvent = _reflection.GeneratedProtocolMessageType('TestLocationsEvent', (_message.Message,), dict(

  TestLocation = _reflection.GeneratedProtocolMessageType('TestLocation', (_message.Message,), dict(
...
_sym_db.RegisterMessage(TestLocationsEvent)
_sym_db.RegisterMessage(TestLocationsEvent.TestLocation)

ChromeInfraEvent = _reflection.GeneratedProtocolMessageType('ChromeInfraEvent', (_message.Message,), dict(
  DESCRIPTOR = _CHROMEINFRAEVENT,
  __module__ = 'chrome_infra_log_pb2'
  # @@protoc_insertion_point(class_scope:crit_event.proto.ChromeInfraEvent)
  ))
_sym_db.RegisterMessage(ChromeInfraEvent)


_CQEVENT.fields_by_name['status'].has_options = True
_CQEVENT.fields_by_name['status']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), _b('\030\001'))
