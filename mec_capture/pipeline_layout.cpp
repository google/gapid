...
void mid_execution_generator::capture_pipeline_layouts(const state_block* state_block, noop_serializer* serializer) const {
  for (auto& it : state_block->VkPipelineLayouts) {
    VkPipelineLayoutWrapper* layout = it.second;
