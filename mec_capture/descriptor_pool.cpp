...
void mid_execution_generator::capture_descriptor_pools(const state_block* state_block, noop_serializer* serializer) const {
  for (auto& it : state_block->VkDescriptorPools) {
    VkDescriptorPoolWrapper* pool = it.second;
