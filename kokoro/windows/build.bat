...
(echo. & echo 24333f8a63b6825ea9c5514f83c2829b004d1fee) > "%ANDROID_HOME%\licenses\android-sdk-license"
%ANDROID_HOME%\tools\bin\sdkmanager build-tools;29.0.2 platforms;android-26
