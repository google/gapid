...
# Get bazel.
curl -L -k -O -s https://github.com/bazelbuild/bazel/releases/download/0.13.0/bazel-0.13.0-without-jdk-installer-linux-x86_64.sh
mkdir bazel
bash bazel-0.13.0-without-jdk-installer-linux-x86_64.sh --prefix=$PWD/bazel
