...
# Get bazel.
curl -L -k -O -s https://github.com/bazelbuild/bazel/releases/download/0.12.0/bazel-0.12.0-without-jdk-installer-darwin-x86_64.sh
mkdir bazel
sh bazel-0.12.0-without-jdk-installer-darwin-x86_64.sh --prefix=$PWD/bazel
