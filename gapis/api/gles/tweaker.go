...
func (t *tweaker) glGenBuffer(ctx context.Context) BufferId {
	id := BufferId(newUnusedID(ctx, 'B', func(x uint32) bool { return t.c.Objects.Shared.Buffers.Get(BufferId(x)) != nil }))
...
func (t *tweaker) glGenRenderbuffer(ctx context.Context) RenderbufferId {
	id := RenderbufferId(newUnusedID(ctx, 'R', func(x uint32) bool { return t.c.Objects.Shared.Renderbuffers.Get(RenderbufferId(x)) != nil }))
	tmp := t.AllocData(ctx, id)
	t.doAndUndo(ctx,
...
func (t *tweaker) glGenTexture(ctx context.Context) TextureId {
	id := TextureId(newUnusedID(ctx, 'T', func(x uint32) bool { return t.c.Objects.Shared.Textures.Get(TextureId(x)) != nil }))
	tmp := t.AllocData(ctx, id)
	t.doAndUndo(ctx,
...
func (t *tweaker) glCreateProgram(ctx context.Context) ProgramId {
	id := ProgramId(newUnusedID(ctx, 'P', func(x uint32) bool {
		return t.c.Objects.Shared.Programs.Get(ProgramId(x)) != nil || t.c.Objects.Shared.Shaders.Get(ShaderId(x)) != nil
	}))
	t.doAndUndo(ctx,
