...
func (a *A) CmdFlags(context.Context, *api.State) api.CmdFlags { return a.Flags }
...
func (*B) CmdFlags(context.Context, *api.State) api.CmdFlags { return 0 }
...
func (X) CmdFlags(context.Context, *api.State) api.CmdFlags { return 0 }
