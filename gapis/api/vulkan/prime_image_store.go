...
var (
	descriptorSetLayoutInfoForStore descriptorSetLayoutInfo
)

func init() {
	descriptorSetLayoutInfoForStore.bindings = map[uint32]descriptorSetLayoutBindingInfo{}
	descriptorSetLayoutInfoForStore.bindings[ipStoreOutputImageBinding] = descriptorSetLayoutBindingInfo{
		VkDescriptorType_VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,
		1, VkShaderStageFlags(VkShaderStageFlagBits_VK_SHADER_STAGE_COMPUTE_BIT),
	}
	descriptorSetLayoutInfoForStore.bindings[ipStoreInputImageBinding] = descriptorSetLayoutBindingInfo{
		VkDescriptorType_VK_DESCRIPTOR_TYPE_STORAGE_IMAGE,
		1, VkShaderStageFlags(VkShaderStageFlagBits_VK_SHADER_STAGE_COMPUTE_BIT),
	}
}
