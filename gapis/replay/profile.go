...
// ProfilePostBack is a transform that causes a post back at the end of the replay.
type ProfilePostBack struct {
	Res []Result
}

func (t *ProfilePostBack) Transform(ctx context.Context, id api.CmdID, cmd api.Cmd, out transform.Writer) {
