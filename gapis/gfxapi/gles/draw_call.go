...
func (GlDrawArraysIndirect) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawArraysIndirect.getIndices() not implemented")
}
func (GlDrawArraysInstanced) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawArraysInstanced.getIndices() not implemented")
}
func (GlDrawArraysInstancedANGLE) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawArraysInstancedANGLE.getIndices() not implemented")
}
func (GlDrawArraysInstancedBaseInstanceEXT) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawArraysInstancedBaseInstanceEXT.getIndices() not implemented")
}
func (GlDrawArraysInstancedEXT) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawArraysInstancedEXT.getIndices() not implemented")
}
func (GlDrawArraysInstancedNV) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawArraysInstancedNV.getIndices() not implemented")
}
func (GlDrawElementsBaseVertex) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsBaseVertex.getIndices() not implemented")
}
func (GlDrawElementsBaseVertexEXT) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsBaseVertexEXT.getIndices() not implemented")
}
func (GlDrawElementsBaseVertexOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsBaseVertexOES.getIndices() not implemented")
}
func (GlDrawElementsIndirect) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsIndirect.getIndices() not implemented")
}
func (GlDrawElementsInstanced) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsInstanced.getIndices() not implemented")
}
func (GlDrawElementsInstancedANGLE) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsInstancedANGLE.getIndices() not implemented")
}
func (GlDrawElementsInstancedBaseInstanceEXT) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsInstancedBaseInstanceEXT.getIndices() not implemented")
}
func (GlDrawElementsInstancedBaseVertex) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsInstancedBaseVertex.getIndices() not implemented")
}
func (GlDrawElementsInstancedBaseVertexBaseInstanceEXT) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsInstancedBaseVertexBaseInstanceEXT.getIndices() not implemented")
}
func (GlDrawElementsInstancedBaseVertexEXT) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsInstancedBaseVertexEXT.getIndices() not implemented")
}
func (GlDrawElementsInstancedBaseVertexOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsInstancedBaseVertexOES.getIndices() not implemented")
}
func (GlDrawElementsInstancedEXT) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsInstancedEXT.getIndices() not implemented")
}
func (GlDrawElementsInstancedNV) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawElementsInstancedNV.getIndices() not implemented")
}
func (GlDrawRangeElements) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawRangeElements.getIndices() not implemented")
}
func (GlDrawRangeElementsBaseVertex) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawRangeElementsBaseVertex.getIndices() not implemented")
}
func (GlDrawRangeElementsBaseVertexEXT) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawRangeElementsBaseVertexEXT.getIndices() not implemented")
}
func (GlDrawRangeElementsBaseVertexOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawRangeElementsBaseVertexOES.getIndices() not implemented")
}
func (GlDrawTexfOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawTexfOES.getIndices() not implemented")
}
func (GlDrawTexfvOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawTexfvOES.getIndices() not implemented")
}
func (GlDrawTexiOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawTexiOES.getIndices() not implemented")
}
func (GlDrawTexivOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawTexivOES.getIndices() not implemented")
}
func (GlDrawTexsOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawTexsOES.getIndices() not implemented")
}
func (GlDrawTexsvOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawTexsvOES.getIndices() not implemented")
}
func (GlDrawTexxOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
	return nil, 0, fmt.Errorf("GlDrawTexxOES.getIndices() not implemented")
}
func (GlDrawTexxvOES) getIndices(log.Context, *Context, *gfxapi.State) ([]uint32, GLenum, error) {
